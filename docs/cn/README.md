...
TradingAgents 是一个基于多 Agent（Agent）协作的 LLM 金融交易决策框架。它的核心能力包括以下几个方面：
...
| [09-a-share-extension-design.md](09-a-share-extension-design.md) | 70 分钟 | 准备做中国市场扩展的人 | A 股二次开发的目标架构、数据源方案、日历与 benchmark 设计、测试矩阵与阶段路线 |
...
8. 想系统设计 A 股支持方案，而不是零散补丁：读 [09-a-share-extension-design.md](09-a-share-extension-design.md)。
...
__文档元信息__
难度：⭐⭐ | 类型：文档导航 | 更新日期：2026-04-07 | 预计阅读时间：20 分钟
