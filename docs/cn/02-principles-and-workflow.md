...
系统不是"看模型什么时候想停"，而是"由图定义什么条件下进入下一阶段"。对研究框架来说，这种可控性非常重要。
...
当前 BM25 的局限也要说清楚：它更擅长词面匹配，不擅长强语义泛化。所以它不是“最强记忆方案”，而是“当前阶段最稳妥的工程方案”。

当前阶段优先用 BM25 而非向量检索，有三个理由：
